...
#' This is due to differences in how ambiguous reads, e.g. mapping across exon-intron boundaries or in genomic regions that can be either exonic or intronic depending on which transcript isoform is considered, are handled.
#'
