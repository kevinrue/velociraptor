...
test_that("plotVelocity runs", {
    ...
    expect_error(plotVelocity(out1, genes2, 1, colour_by = "error"))
    expect_error(plotVelocity(out1, genes2, 1, colour.alpha = "error"))
    expect_error(plotVelocity(out1, genes2, 1, colours.velocity = "error"))
    expect_error(plotVelocity(out1, genes2, 1, colours.expression = "error"))
...
test_that("plotVelocityStream runs", {
    ...
    expect_error(plotVelocityStream(out2, em2, colour.streamlines = "error"))
    expect_error(plotVelocityStream(out2, em2, colour.streamlines.map = "error"))
